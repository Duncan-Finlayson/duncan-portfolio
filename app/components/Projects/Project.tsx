...
const Project = ({thumbnail, 
    ...
    languageIcons}: Props) => {
        ...
        const xRotation = useTransform(ySpring, 
            [-0.5, 0.5], ["15deg", "-15deg"])
        const yRotation = useTransform(xSpring, 
            [-0.5, 0.5], ["-15deg", "15deg"])
  ...
  <motion.div onMouseMove = {handleMouseMove} onMouseOut = {handleMouseLeave} className="card flex flex-col
   items-stretch w-full max-w-[428.4px] p-5 md:p-[18px] gap-[30px]"
   ...
   >
    ...
    width ={392}
    height = {230} className="w-full h-[230px] object-cover"
    style = {{
