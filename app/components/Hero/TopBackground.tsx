...
const TopBackground = () => {
  ...
  md:max-w-screen-lg h-[285px] md:h-[656px]
    ...
    <div className="w-full h-full relative">
        ...
        <div className="circle-icon top-30 left-[60px] md:top-[592px] md:left-[608px]">
            <Image 
        ...
        <div className="circle-icon top-[146px] -right-[68px] md:top-[158px] md:left-[606px]">
        ...
        <div className="circle-icon top-[45px] right-[60px] md:top-
        [368px] md:left-[965px]">
            <Image 
            src="/stack_icon.svg"
            alt="Stack icon"
  ...
  <div className ="absolute top-0 w-full h-[600px] bg-repeat-x bg-[url('/top_bg_mobile_light.svg')] bg-[auto_auto] hidden dark:hidden md:hidden" />
  <div className ="absolute top-0 w-full h-[795px] bg-repeat-x bg-[url('/top_bg_dark.svg')] bg-[auto_auto] hidden md:dark:block" />
  <div className ="absolute top-0 w-full h-[600px] bg-repeat-x bg-[url('/top_bg_mobile_dark.svg')] bg-[auto_auto] hidden dark:block dark:md:hidd" />
  </>
